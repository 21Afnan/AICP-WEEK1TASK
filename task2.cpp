...
//Ask user for additional items:
    ...
    //for another hard drive
      ...
      {
          cout<<endl;
		  cout << "You chose not to opt a second hard drive." << endl;
      } 
      else 
      {
          cout<<endl;
    ...
    cout << " Do you want to purchase Optical drive  (DVD/Blu-Ray-Player , Professional Version)?" << endl;
    cin >> c;
    cout<<endl;
       ...
       cout<<endl;
       cout << "Do you want to purchase Operating System  (Standard Version, Professional Version)?" << endl;
       cin >> c;
...
//If user chose No for additional items
	...
	cout<<"Total price after adding additional items:\t$" << totalprice << endl;
